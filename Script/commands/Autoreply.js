...
module.exports.handleEvent = async function ({ api, event, Users }) {
  ...
  const responses = {
    "miss you": "অরেক বেডারে Miss না করে xan মেয়ে হলে বস  রে হাঙ্গা করো😶👻😘",
    ...
    "virus": "উনি এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘",
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ 𝐍𝐨𝐛𝐢𝐭𝐚☜\nFacebook: https://www.facebook.com/ur.dad.j3rry\n",
    "admin": "He is 𝐍𝐨𝐛𝐢𝐭𝐚 তাকে সবাই NOBITA The Cyber Warrior হিসেবে চিনে😘☺️",
    ...
    "fork": "https://github.com/NOBITAtcw/ntcwbot",
    ...
    "ami virus": "হ্যা বস কেমন আছেন..?☺️",
    "bot er baccha": "আমার বাচ্চা তো তোমার গার্লফ্রেন্ডের পেটে..!!🌚⛏️",
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌𝐂𝐮𝐭𝐢𝐞 𝐂𝐡𝐚𝐭 𝐁𝐨𝐭💖",
